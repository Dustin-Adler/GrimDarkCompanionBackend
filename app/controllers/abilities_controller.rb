class AbilitiesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to abilities_path, status: :see_other, notice: "Ability was successfully destroyed." }
  ...
  private
    ...
    def set_ability
      @ability = Ability.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def ability_params
      params.expect(ability: [ :id, :name, :description, :rule, :example, :tldr ])
    end
end
