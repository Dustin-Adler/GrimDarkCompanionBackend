class WeaponsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to weapons_path, status: :see_other, notice: "Weapon was successfully destroyed." }
  ...
  private
    ...
    def set_weapon
      @weapon = Weapon.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def weapon_params
      params.expect(weapon: [ :id, :name, :meelee, :range, :attacks, :proficiency, :strength, :damage ])
    end
end
