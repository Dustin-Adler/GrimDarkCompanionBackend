...
def create_ork_models(ork_model_seeds)
    ...
    ork_model_seeds.each do |model|
        ...
        Model.create(
            ...
            army_id: model[:army_id],
            cost: model[:cost],
            min_squad: model[:min_squad],
            max_squad: model[:max_squad],
            unit_limit: model[:unit_limit],
...
makari = ork_model_seeds.push({
    ...
    leadership: 8,
    obj_control: 1,
    affiliate_model_id: "Ghazghkull Thraka"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Burna Boyz - Spanner"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Burna Boyz - Boy"
})
...
gretchin_runtherd = ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Gretchin - Grot"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Kommandos - Boss Nob"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Kommandos - Kommando"
})
...
lootas_spanna = ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Lootas - Loota"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 2,
    affiliate_model_id: "Squighog Boyz - Nob on Smasha Squig"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 2,
    affiliate_model_id: "Squighog Boyz - Squighog Boy"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Stormboy - Boss Nob"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Stormboy - Stormboy"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 2,
    affiliate_model_id: "Warbikers - Boss Nob on Warbike"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 2,
    affiliate_model_id: "Warbikers - Warbiker"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Breaka Boyz - Boss Nob"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Breaka Boyz - Boy"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Tankbustas - Boss Nob"
})
...
ork_model_seeds.push({
    ...
    leadership: 7,
    obj_control: 1,
    affiliate_model_id: "Tankbustas - Tankbusta"
})
