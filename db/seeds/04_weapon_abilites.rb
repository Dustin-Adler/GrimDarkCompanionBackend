...
weapon_abilities["Torrent"] = {
    name: "Torrent",
    description: "Torrent weapons shoot clouds of fire, gas or other lethal substances that few foes can hope to evade.",
...
weapon_abilities["Lethal Hits"] = {
    name: "Lethal Hits",
    description: "Some weapons can inflict fatal injuries on any foe, no matter their resilience.",
...
weapon_abilities["Lance"] = {
    name: "Lance",
    description: "Lance weapons are deadly on the charge.",
...
weapon_abilities["Blast"] = {
    name: "Blast",
    description: "High-explosives can fell several warriors in a single blast, but firing them where your comrades will get caught in the ensuing detonation is simply unwise.",
...
weapon_abilities["Precision"] = {
    name: "Precision",
    description: "Precision attacks can pick high-value targets out in a crowd, whether through the unerring aim of a sniper or the pinpoint accuracy of a blade-master’s strike.",
...
weapon_abilities["Heavy"] = {
    name: "Heavy",
    description: "Heavy weapons are amongst the biggest guns on the battlefield, but require bracing to fire at full effect and are unwieldy to bring to bear at close quarters.",
...
weapon_abilities["Sustained Hits"] = {
    name: "Sustained Hits",
    description: "Some weapons strike in a flurry of blows, tearing the foe apart with relentless ferocity.",
...
weapon_abilities["Hazardous"] = {
    name: "Hazardous",
    description: "Weapons powered by unstable and dangerous energy sources pose a substantial risk to the wielder every time they are used.",
...
weapon_abilities["Devastating Wounds"] = {
    ...
    description: "Some weapons can inflict strikes of such power that they make a mockery of armour and can cleave through several foes.",
...
weapon_abilities["Anti"] = {
    name: "Anti",
    description: "Certain weapons are the bane of a particular foe.",
