...
class ArmiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create army" do
    assert_difference("Army.count") do
      post armies_url, params: { army: { ability: @army.ability, description: @army.description, name: @army.name } }
    end
  ...
  test "should update army" do
    patch army_url(@army), params: { army: { ability: @army.ability, description: @army.description, name: @army.name } }
